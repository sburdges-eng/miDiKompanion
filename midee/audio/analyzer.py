...
from midee.audio.chord_detection import ChordDetector, ChordProgressionDetection
from midee.audio.frequency_analysis import analyze_frequency_bands, FrequencyProfile
