...
Usage:
    from midee.orchestrator.processors import GrooveProcessor
...
from midee.orchestrator.processors.base import BaseProcessor
from midee.orchestrator.interfaces import (
    ProcessorConfig,
    ProcessorResult,
    ExecutionContext,
)
...
class GrooveProcessor(BaseProcessor):
    ...
    in midee.groove and midee.session.intent_processor.
    ...
    async def _generate_groove(self, input_data: GrooveInput) -> GrooveOutput:
        ...
        from midee.session.intent_processor import (
