...
@patch("midee.structure.comprehensive_engine.MIDO_AVAILABLE", True)
@patch("midee.daw.logic.LogicProject")
@patch("midee.structure.progression.parse_progression_string")
