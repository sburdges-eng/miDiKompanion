...
from midee.structure.chord import Chord, ChordProgression
from midee.structure.progression import diagnose_progression, generate_reharmonizations
from midee.groove.templates import get_genre_template, list_genre_templates
...
class TestDataFiles:
    ...
    def test_rule_breaks_json_loadable(self):
        from midee.data import rule_breaking_database
    ...
    def test_emotional_mapping_exists(self):
        from midee.data import kelly.emotional_mapping
