...
@patch("midee.structure.comprehensive_engine.render_plan_to_midi")
def test_cli_happy_path(mock_render, mock_input):
    """Simulate a full user session end-to-end."""
    from midee.structure.comprehensive_engine import run_cli
...
def test_harmony_plan_custom_chord_symbols():
    ...
    from midee.structure.comprehensive_engine import HarmonyPlan
