...
# Check if numpy is available (required by midee.api)
try:
    import numpy as np
...
class TestGrooveOperations:
    ...
    def test_humanize_drums(self):
        ...
        from midee.api import DAiWAPI
        from midee.groove.templates import create_basic_drum_pattern
        import tempfile
        import os
...
class TestAPIModuleExports:
    ...
    def test_convenience_api_type(self):
        ...
        from midee.api import DAiWAPI, api
...
class TestAudioAnalysis:
    ...
    def test_audio_analyzer_import(self):
        ...
        from midee.audio import AudioAnalyzer, AudioAnalysis
    ...
    def test_audio_analysis_to_dict(self):
        ...
        from midee.audio import AudioAnalysis
