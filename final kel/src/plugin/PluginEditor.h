 ...
 *
 * CRITICAL: This is the main UI entry point for the plugin. It serves as the bridge
 * between the PluginProcessor (audio/MIDI processing) and all UI components.
 *
 * Responsibilities:
 ...
 *    - Parameter sliders: Valence, Arousal, Intensity, Complexity, Humanize, Feel, Dynamics, Bars
 ...
 *    - Emotion selection: Updates parameters and music theory based on selected emotion
 *
 * 4. Window management:
...
public:
     ...
     * @param processor Reference to PluginProcessor (lifetime managed by JUCE framework)
     */
