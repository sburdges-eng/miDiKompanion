...
// Renamed from GrooveEngine to avoid conflict with src/midi/GrooveEngine
// This engine generates drum groove patterns, while midi/GrooveEngine processes MIDI notes
class DrumGrooveEngine {
public:
    DrumGrooveEngine();
