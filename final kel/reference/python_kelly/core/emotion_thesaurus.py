...
TRUST_EMOTIONS = [
    ("warmth", 0.17, 0.4, 0.35, "Gentle caring feeling"),
    ("acceptance", 0.17, 0.5, 0.3, "Calm acknowledgment"),
    ("safety", 0.33, 0.5, 0.2, "Feeling secure"),
    ("tenderness", 0.33, 0.5, 0.4, "Soft affection"),
    ("affection", 0.5, 0.6, 0.5, "Warm fondness"),
    ("trust", 0.5, 0.6, 0.4, "Core positive emotion"),
    ("belonging", 0.67, 0.6, 0.5, "Feeling part of something"),
    ("adoration", 0.67, 0.85, 0.75, "Deep admiration"),
    ("love", 0.83, 0.9, 0.7, "Profound connection"),
    ("devotion", 0.83, 0.85, 0.65, "Deep commitment"),
    ("reverence", 1.0, 0.8, 0.6, "Sacred respect"),
    ("transcendent_love", 1.0, 0.95, 0.8, "Ultimate connection"),
]

ANTICIPATION_EMOTIONS = [
    ("interest", 0.17, 0.3, 0.5, "Engaged attention"),
    ("curiosity", 0.17, 0.4, 0.6, "Active wondering"),
    ("vigilance", 0.33, 0.2, 0.7, "Watchful awareness"),
    ("expectation", 0.33, 0.5, 0.55, "Looking forward"),
    ("eagerness", 0.5, 0.7, 0.75, "Enthusiastic waiting"),
    ("anticipation", 0.5, 0.6, 0.7, "Core forward-looking emotion"),
    ("excitement", 0.67, 0.9, 0.9, "Thrilled expectation"),
    ("yearning", 0.67, 0.7, 0.6, "Longing desire"),
    ("impatience", 0.83, 0.6, 0.85, "Restless waiting"),
    ("feverish_anticipation", 0.83, 0.85, 0.95, "Intense forward energy"),
    ("burning_desire", 1.0, 0.9, 1.0, "Overwhelming want"),
    ("transcendent_hope", 1.0, 0.95, 0.9, "Ultimate forward vision"),
]
...
class EmotionThesaurus:
    ...
    def _build_thesaurus(self):
        """Build the complete emotion thesaurus (now 96 nodes with Trust and Anticipation)."""
        node_id = 0
        emotion_lists = [
            ...
            (EmotionCategory.TRUST, TRUST_EMOTIONS),
            (EmotionCategory.ANTICIPATION, ANTICIPATION_EMOTIONS),
        ]
