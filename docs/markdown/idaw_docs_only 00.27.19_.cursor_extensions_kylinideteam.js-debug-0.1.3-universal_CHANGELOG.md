...
- feat: Changed the icon and plugin name to avoid confusion with vscode-js-debug
- feat: feat: base on vscode-js-debug 1.85.0
...
- feat: add cdp sharing for extensions to interact with debugging, see [docs](https://github.com/microsoft/vscode-js-debug/blob/main/CDP_SHARE.md) ([#892](https://github.com/microsoft/vscode-js-debug/issues/893))
