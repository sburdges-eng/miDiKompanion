<h1>
  JavaScript Debugger(for KylinOS)
</h1>
...
1. Open the extensions view (ctrl+shift+x) and search for `@builtin @id:KylinIDETeam.js-debug`
2. Right click on the `JavaScript Debugger` extension and `Disable` it.
3. Search for `@id:KylinIDETeam.js-debug-nightly` in the extensions view.
