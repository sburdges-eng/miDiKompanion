...
- Added registers view ([@nomtats]) [#242](https://github.com/WebFreak001/code-debug/issues/242)
- Enabled breakpoints inside `riscv` files ([@William-An]) [#404](https://github.com/WebFreak001/code-debug/issues/404)
