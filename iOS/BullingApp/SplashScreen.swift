...
//  Bulling
//
//  Loading screen with bull head logo (dartboard eyes, bowling pin horns)
//
...
struct SplashScreen: View {
    ...
    @State private var animateEyes = false
    @State private var animateHorns = false
...
// Keep the teardrop shape for potential future use
