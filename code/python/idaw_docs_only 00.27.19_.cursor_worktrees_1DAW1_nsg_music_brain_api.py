...
async def generate_music(request: GenerateRequest):
    ...
    try:
        ...
        # Check if using new emotion-based format
        if intent.base_emotion and intent.intensity:
            ...
            mode = music_params["mode"].lower()  # Convert "Aeolian" to "minor", etc.
            tempo = music_params["tempo"]
            progression = music_params["progression"]

            # Convert mode names to generator format
            mode_map = {
                "aeolian": "minor",
                "ionian": "major",
                "phrygian": "minor",  # Phrygian is a minor mode
                "locrian": "minor",   # Locrian is a minor mode
                "dorian": "minor",    # Dorian is a minor mode
                "mixolydian": "major", # Mixolydian is a major mode
                "lydian": "major"      # Lydian is a major mode
            }
            mode = mode_map.get(mode, "minor" if "minor" in mode else "major")

            # Use progression to determine mood for generator
        ...
        song = generator.generate(
            ...
            mode=mode,
            mood=mood,
            genre=technical.get("genre") if technical else None,
