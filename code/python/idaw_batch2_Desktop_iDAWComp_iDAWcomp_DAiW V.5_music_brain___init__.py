...
Modules:
- models: Emotional → Musical parameter mapping (NEW in v0.5.0)
...
# Models (Emotional → Musical mapping)
from .models import (
    TimingFeel, Register, HarmonicRhythm, Density,
    EmotionalState, MusicalParameters,
    EMOTIONAL_PRESETS, EMOTION_MODIFIERS, INTERVAL_EMOTIONS,
    CHORD_PROGRESSION_EMOTIONS, EMOTIONAL_STATE_PRESETS,
    get_parameters_for_state, get_interrogation_prompts, get_misdirection_technique
)
