...
# ============ MENUBAR APP ============
class iDAWMenubarApp(rumps.App):
    """Menubar application for iDAW."""
    
    def __init__(self):
        super().__init__("🎵", quit_button=None)
        self.menu = [
            rumps.MenuItem("iDAW Listener", callback=None),
            None,  # Separator
    ...
    def process_instruction(self, json_path: Path):
        ...
        try:
            ...
            generator = iDAWGenerator(config)
...
if __name__ == "__main__":
    print(f"iDAW Listener starting...")
