#!/usr/bin/env python3
"""
iDAW Listener - Terminal Version (Public)
==========================================
...
Usage:
    python idaw_listener.py [--output-dir ./output] [--watch-dir ./incoming]
...
# ============ CONFIGURATION ============
DEFAULT_OUTPUT = Path("./idaw_output")
DEFAULT_WATCH = Path("./idaw_incoming")
...
class IncomingHandler(FileSystemEventHandler):
    ...
    def process_file(self, json_path: Path):
        ...
        try:
            ...
            generator = iDAWGenerator(config, self.output_dir)
...
# ============ MAIN ============
def main():
    parser = argparse.ArgumentParser(description="iDAW Listener - Generate music from JSON instructions")
