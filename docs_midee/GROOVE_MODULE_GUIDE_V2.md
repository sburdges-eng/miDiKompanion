...
cp -r groove_templates/ DAiW-Music-Brain/midee/data/groove_templates/
```

### Update `__init__.py`

```python
# In midee/groove/__init__.py
...
def extract_groove(midi_file):
    ...
    from midee.groove import GrooveExtractor, print_groove_analysis
